        ...
        <div className='grid grid-flow-col p-5 m-2 shadow-lg'>
            <div className='flex col-span-1'>
                <img
                    ...
                    alt='Not Loaded' />
                <img className='h-10' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS0vjqOGyOmZ4N4Atj0Wrujl7yP-_2iMDxzTg&s" alt="Not Loaded" />
            </div>
